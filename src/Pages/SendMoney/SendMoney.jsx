...
import SendMonyCurd from "./SendMonyCurd";
  ...
  return (
    <div>
      <div
        ...
        style={{
          backgroundImage:
            "url('https://jupiter.money/content/images/2021/09/how_to_transfer_money_online.jpg')",
          height: "550px",
        }}
      >
        <div
        ...
        >
          <div className="flex h-full items-center justify-center">
            <div className="text-white">
              <h2 className="mb-4 text-4xl font-semibold">Send Money</h2>
