...
<div className="flex flex-wrap items-center justify-center">
    <div className="relative flex-shrink-0 w-[300px] mx-2 mb-6  h-96 overflow-hidden bg-yellow-500 rounded-lg shadow-lg">
        ...
        <div className="relative flex items-center justify-center px-10 pt-10">
            ...
            <div className="relative flex-shrink-0 w-[300px] max-w-xs mx-2 h-96 mb-6 overflow-hidden bg-blue-500 rounded-lg shadow-lg sm:mb-0">
                <svg className="absolute bottom-0 left-0 mb-8" viewBox="0 0 375 283" fill="none">
            ...
            <div className="relative flex-shrink-0 w-[300px] max-w-xs mx-2 h-96 -mb-6 overflow-hidden bg-purple-500 rounded-lg shadow-lg">
                <svg className="absolute bottom-0 left-0 mb-8" viewBox="0 0 375 283" fill="none">
